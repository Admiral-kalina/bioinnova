...
//asset
import aboutBgBottom from "../../images/about/about-bg-bottom.png";
import aboutBgBottomMobile from "../../images/about/about-bg-bottom-mobile.png";
import aboutBgTop from "../../images/about/about-bg-top.png";
import aboutBgTopMobile from "../../images/about/about-bg-top-mobile.png";

import aboutBgMiddle from "../../images/about/about-bg-middle.png";
        ...
        <main>
                ...
                <div className="container d-block-md">
                    <section className="description-block__wrapper">
                        ...
                        <picture>
                            ...
                            <img src={aboutBgMiddle} alt="human hands typing on a keyboard"/>
                        </picture>
                    </section>
                </div>
            </article>
            <article className="main-areas">
                <picture className="main-areas__bg">
                    ...
                    <img src={aboutBgMiddleLines} alt="background lines"/>
                </picture>
                <div className="container d-block-md">
